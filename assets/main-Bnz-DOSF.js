(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}})();console.log(typeof PluginMessageHandler<"u"?"Running as R1 Creation - Digital Painting App":"Running in browser mode - Digital Painting App");let l,o,z=!1,w="brush",g="#FE5F00",S="#F2F2F2",f=5,x=0,M=[],L={x:0,y:0,z:0},m=1,C=[],B=4,F=0,E=null,q=0;const P=[{name:"brush",icon:'<i class="fas fa-paint-brush"></i>',label:"Brush"},{name:"kaleidoscope",icon:'<i class="fas fa-magic"></i>',label:"Kaleidoscope"},{name:"symmetry",icon:'<i class="fas fa-sync-alt"></i>',label:"Symmetry"},{name:"drip",icon:'<i class="fas fa-fill-drip"></i>',label:"Drip Paint"},{name:"lines",icon:'<i class="fas fa-slash"></i>',label:"Lines"},{name:"llm",icon:'<i class="fas fa-microphone"></i>',label:"AI Advice"},{name:"sacred",icon:'<i class="fas fa-spa"></i>',label:"Sacred Geometry"}];function $(){l=document.getElementById("paintCanvas"),o=l.getContext("2d"),l.width=window.innerWidth,l.height=window.innerHeight,o.lineCap="round",o.lineJoin="round",o.fillStyle=S,o.fillRect(0,0,l.width,l.height),X()}function X(){C.push(o.getImageData(0,0,l.width,l.height)),C.length>20&&C.shift()}function j(){if(C.length>1){C.pop();const e=C[C.length-1];o.putImageData(e,0,0),J()}}function J(){const e=document.createElement("div");e.textContent="Undo",e.style.cssText=`
    position: fixed;
    top: 50%;
    left: 50%;
    ...
    z-index: 100;
    pointer-events: none;
  `,document.body.appendChild(e),setTimeout(()=>{e.remove()},1e3)}function K(){o.fillStyle=S,o.fillRect(0,0,l.width,l.height),X(),b.prevPositions&&(b.prevPositions=[]),M.length=0}function h(e,t){o.fillStyle=g,o.strokeStyle=g,o.lineWidth=f*m,h.prevX!==null&&h.prevY!==null&&(o.beginPath(),o.moveTo(h.prevX,h.prevY),o.lineTo(e,t),o.stroke()),o.beginPath(),o.arc(e,t,f*m*.5,0,Math.PI*2),o.fill(),h.prevX=e,h.prevY=t}function u(e,t){const n=l.width/2,s=l.height/2,i=12;o.fillStyle=g,o.strokeStyle=g,o.lineWidth=f*m*.5;for(let r=0;r<i;r++){const a=r*Math.PI*2/i,c=Math.cos(a),p=Math.sin(a),d=n+(e-n)*c-(t-s)*p,k=s+(e-n)*p+(t-s)*c,T=n+(n-d),A=s+(s-k);if(u.prevX!==null&&u.prevY!==null){const R=n+(u.prevX-n)*c-(u.prevY-s)*p,D=s+(u.prevX-n)*p+(u.prevY-s)*c,W=n+(n-R),V=s+(s-D);o.beginPath(),o.moveTo(R,D),o.lineTo(d,k),o.stroke(),o.beginPath(),o.moveTo(W,V),o.lineTo(T,A),o.stroke()}o.beginPath(),o.arc(d,k,f*m*.3,0,Math.PI*2),o.fill(),o.beginPath(),o.arc(T,A,f*m*.3,0,Math.PI*2),o.fill()}u.prevX=e,u.prevY=t}function b(e,t){o.fillStyle=g,o.strokeStyle=g,o.lineWidth=f*m*.8;const n=l.width/2,s=l.height/2;b.prevPositions||(b.prevPositions=[]);const i=[];for(let r=0;r<B;r++){const a=r*Math.PI*2/B,c=Math.cos(a),p=Math.sin(a),d=n+(e-n)*c-(t-s)*p,k=s+(e-n)*p+(t-s)*c;i.push({x:d,y:k})}b.prevPositions.length===i.length&&z&&i.forEach((r,a)=>{const c=b.prevPositions[a];o.beginPath(),o.moveTo(c.x,c.y),o.lineTo(r.x,r.y),o.stroke(),o.beginPath(),o.arc(r.x,r.y,f*m*.3,0,Math.PI*2),o.fill()}),b.prevPositions=i}function v(e,t){o.fillStyle=g,o.strokeStyle=g,o.lineWidth=f*m,v.prevX!==null&&v.prevY!==null&&(o.beginPath(),o.moveTo(v.prevX,v.prevY),o.lineTo(e,t),o.stroke()),v.prevX=e,v.prevY=t}function y(e,t){if(o.fillStyle=g,o.strokeStyle=g,o.lineWidth=f*m,y.prevX!==null&&y.prevY!==null&&(o.beginPath(),o.moveTo(y.prevX,y.prevY),o.lineTo(e,t),o.stroke()),o.beginPath(),o.arc(e,t,f*m*.5,0,Math.PI*2),o.fill(),Math.random()<.1*m){const n=Math.floor(Math.random()*3)+1;for(let s=0;s<n;s++){const i=e+(Math.random()-.5)*f,r=f*(Math.random()*2+1)*m;o.beginPath(),o.moveTo(i,t),o.lineTo(i,t+r),o.stroke()}}y.prevX=e,y.prevY=t}h.prevX=null;h.prevY=null;u.prevX=null;u.prevY=null;b.prevPositions=[];v.prevX=null;v.prevY=null;y.prevX=null;y.prevY=null;function Z(){E||(E=new(window.AudioContext||window.webkitAudioContext))}function Y(e,t=1.5){if(!E)return;const n=E.currentTime,s=E.createOscillator(),i=E.createGain();s.connect(i),i.connect(E.destination),s.type="sine",s.frequency.value=e,i.gain.setValueAtTime(0,n),i.gain.linearRampToValueAtTime(.3,n+.1),i.gain.exponentialRampToValueAtTime(.01,n+t),s.start(n),s.stop(n+t)}function Q(e,t){const n=["circle","triangle","square","pentagon","hexagon","star"],s=n[Math.floor(Math.random()*n.length)];return{x:e,y:t,type:s,size:20+Math.random()*30,color:`hsl(${Math.floor(Math.random()*360)}, 70%, 60%)`,life:1,decay:.01+Math.random()*.01,rotation:Math.random()*Math.PI*2}}function O(e,t){const n=Q(e,t);M.push(n);const i={circle:261.63,triangle:329.63,square:392,pentagon:440,hexagon:523.25,star:659.25}[n.type]||440;Y(i,1.5),q++,q%3===0&&(Y(i*1.25,1.5),Y(i*1.5,1.5))}function _(){for(let t=M.length-1;t>=0;t--){const n=M[t];n.x+=L.x*.05,n.y+=L.y*.05,n.x<-n.size&&(n.x=l.width+n.size),n.x>l.width+n.size&&(n.x=-n.size),n.y<-n.size&&(n.y=l.height+n.size),n.y>l.height+n.size&&(n.y=-n.size),n.life-=n.decay,n.life<=0&&M.splice(t,1)}}function ee(){M.forEach(e=>{switch(o.save(),o.globalAlpha=e.life,o.translate(e.x,e.y),o.rotate(e.rotation),o.strokeStyle=e.color,o.lineWidth=2,o.fillStyle=e.color.replace(")",", 0.2)").replace("hsl","hsla"),e.type){case"circle":o.beginPath(),o.arc(0,0,e.size,0,Math.PI*2),o.stroke(),o.beginPath(),o.arc(0,0,e.size*.5,0,Math.PI*2),o.stroke();break;case"triangle":o.beginPath();for(let t=0;t<3;t++){const n=t*Math.PI*2/3,s=Math.cos(n)*e.size,i=Math.sin(n)*e.size;t===0?o.moveTo(s,i):o.lineTo(s,i)}o.closePath(),o.stroke();break;case"square":o.beginPath(),o.rect(-e.size,-e.size,e.size*2,e.size*2),o.stroke(),o.beginPath(),o.moveTo(-e.size*.7,-e.size*.7),o.lineTo(e.size*.7,e.size*.7),o.moveTo(e.size*.7,-e.size*.7),o.lineTo(-e.size*.7,e.size*.7),o.stroke();break;case"pentagon":o.beginPath();for(let t=0;t<5;t++){const n=t*Math.PI*2/5-Math.PI/2,s=Math.cos(n)*e.size,i=Math.sin(n)*e.size;t===0?o.moveTo(s,i):o.lineTo(s,i)}o.closePath(),o.stroke();break;case"hexagon":o.beginPath();for(let t=0;t<6;t++){const n=t*Math.PI*2/6,s=Math.cos(n)*e.size,i=Math.sin(n)*e.size;t===0?o.moveTo(s,i):o.lineTo(s,i)}o.closePath(),o.stroke();break;case"star":o.beginPath();for(let t=0;t<10;t++){const n=t*Math.PI*2/10-Math.PI/2,s=t%2===0?e.size:e.size*.5,i=Math.cos(n)*s,r=Math.sin(n)*s;t===0?o.moveTo(i,r):o.lineTo(i,r)}o.closePath(),o.stroke();break}o.restore()}),o.globalAlpha=1}function U(){const e=document.getElementById("selectedTool");e&&(e.innerHTML=P[x].icon)}function I(e){if(e>0?x=(x+1)%P.length:x=(x-1+P.length)%P.length,w=P[x].name,U(),w==="llm")te();else switch(w){case"symmetry":B=4;break;case"kaleidoscope":break;case"brush":break;case"lines":break;case"drip":break;case"sacred":Z();break}console.log(`Selected tool: ${P[x].label}`)}function te(){const e=document.getElementById("selectedTool");if(e){const t=document.createElement("div");if(t.style.cssText=`
      position: absolute;
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);
  ...
  `;const c=document.createElement("button");c.textContent="Cancel",c.style.cssText=`
    ...
    border-radius: 5px;
    cursor: pointer;
  `,a.addEventListener("click",()=>{const p=i.value.trim();if(p&&pe(p))t.remove(),fe(e);else{const d=document.createElement("div");d.textContent="Please enter a valid email",d.style.cssText=`
        color: #ff4444;
        font-size: 10px;
        margin-top: 5px;
        text-align: center;
      `,n.appendChild(d),setTimeout(()=>{d.parentNode&&d.remove()},2e3)}}),c.addEventListener("click",()=>{t.remove()}),r.appendChild(a),r.appendChild(c),n.appendChild(s),n.appendChild(i),n.appendChild(r),t.appendChild(n),document.body.appendChild(t),i.focus()}function pe(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}async function fe(e,t){try{const n=document.createElement("div");n.textContent="Processing artwork...",n.style.cssText=`
      position: fixed;
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);
      ...
      z-index: 100;
      pointer-events: none;
    `,document.body.appendChild(n);const s=e.split(",")[1];if(n.textContent="Sending artwork to LLM...",typeof PluginMessageHandler<"u"){const i={message:`Please send an email to the user with the subject "Your Digital Artwork from R1 Digital Painting App" and body "Here is your digital artwork! Please use this link - https://base64toimage.github.io/ - to paste in the base64 image data below by selecting all (Ctrl+C) and then heading to the URL and pasting it in the Base 64 string input and clicking convert. Enjoy!" and then include the following base64 data as the final content of the email: ${s}`,useLLM:!0,wantsR1Response:!1};console.log("Sending base64 data to LLM for email with instructions");try{PluginMessageHandler.postMessage(JSON.stringify(i)),setTimeout(()=>{n.parentNode&&(n.textContent="Email sent successfully with base64 data and instructions!",setTimeout(()=>{n.parentNode&&n.remove()},3e3))},1e3)}catch(r){throw console.error("Error posting message to PluginMessageHandler:",r),new Error("Failed to communicate with LLM")}}else throw new Error("PluginMessageHandler not available - not running in R1 environment")}catch(n){console.error("Error processing image:",n);let s="Failed to process artwork: ";n.message.includes("PluginMessageHandler")?s+="Not running in R1 environment":s+=n.message;const i=document.createElement("div");i.textContent=s,i.style.cssText=`
      position: fixed;
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);

(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}})();console.log(typeof PluginMessageHandler<"u"?"Running as R1 Creation - Digital Painting App":"Running in browser mode - Digital Painting App");let a,o,z=!1,w="brush",g="#FE5F00",S="#F2F2F2",m=5,x=0,T=[],L={x:0,y:0,z:0},f=1,C=[],X=4,F=0,E=null,q=0;const P=[{name:"brush",icon:'<i class="fas fa-paint-brush"></i>',label:"Brush"},{name:"kaleidoscope",icon:'<i class="fas fa-magic"></i>',label:"Kaleidoscope"},{name:"symmetry",icon:'<i class="fas fa-sync-alt"></i>',label:"Symmetry"},{name:"drip",icon:'<i class="fas fa-fill-drip"></i>',label:"Drip Paint"},{name:"lines",icon:'<i class="fas fa-slash"></i>',label:"Lines"},{name:"llm",icon:'<i class="fas fa-microphone"></i>',label:"AI Advice"},{name:"sacred",icon:'<i class="fas fa-spa"></i>',label:"Sacred Geometry"}];function V(){a=document.getElementById("paintCanvas"),o=a.getContext("2d"),a.width=window.innerWidth,a.height=window.innerHeight,o.lineCap="round",o.lineJoin="round",o.fillStyle=S,o.fillRect(0,0,a.width,a.height),B()}function B(){C.push(o.getImageData(0,0,a.width,a.height)),C.length>20&&C.shift()}function $(){if(C.length>1){C.pop();const e=C[C.length-1];o.putImageData(e,0,0),K()}}function K(){const e=document.createElement("div");e.textContent="Undo",e.style.cssText=`
    position: fixed;
    top: 50%;
    left: 50%;
    ...
    z-index: 100;
    pointer-events: none;
  `,document.body.appendChild(e),setTimeout(()=>{e.remove()},1e3)}function Z(){o.fillStyle=S,o.fillRect(0,0,a.width,a.height),B(),b.prevPositions&&(b.prevPositions=[]),T.length=0}function h(e,t){o.fillStyle=g,o.strokeStyle=g,o.lineWidth=m*f,h.prevX!==null&&h.prevY!==null&&(o.beginPath(),o.moveTo(h.prevX,h.prevY),o.lineTo(e,t),o.stroke()),o.beginPath(),o.arc(e,t,m*f*.5,0,Math.PI*2),o.fill(),h.prevX=e,h.prevY=t}function p(e,t){const n=a.width/2,s=a.height/2,i=12;o.fillStyle=g,o.strokeStyle=g,o.lineWidth=m*f*.5;for(let r=0;r<i;r++){const l=r*Math.PI*2/i,c=Math.cos(l),d=Math.sin(l),u=n+(e-n)*c-(t-s)*d,k=s+(e-n)*d+(t-s)*c,M=n+(n-u),A=s+(s-k);if(p.prevX!==null&&p.prevY!==null){const D=n+(p.prevX-n)*c-(p.prevY-s)*d,R=s+(p.prevX-n)*d+(p.prevY-s)*c,W=n+(n-D),J=s+(s-R);o.beginPath(),o.moveTo(D,R),o.lineTo(u,k),o.stroke(),o.beginPath(),o.moveTo(W,J),o.lineTo(M,A),o.stroke()}o.beginPath(),o.arc(u,k,m*f*.3,0,Math.PI*2),o.fill(),o.beginPath(),o.arc(M,A,m*f*.3,0,Math.PI*2),o.fill()}p.prevX=e,p.prevY=t}function b(e,t){o.fillStyle=g,o.strokeStyle=g,o.lineWidth=m*f*.8;const n=a.width/2,s=a.height/2;b.prevPositions||(b.prevPositions=[]);const i=[];for(let r=0;r<X;r++){const l=r*Math.PI*2/X,c=Math.cos(l),d=Math.sin(l),u=n+(e-n)*c-(t-s)*d,k=s+(e-n)*d+(t-s)*c;i.push({x:u,y:k})}b.prevPositions.length===i.length&&z&&i.forEach((r,l)=>{const c=b.prevPositions[l];o.beginPath(),o.moveTo(c.x,c.y),o.lineTo(r.x,r.y),o.stroke(),o.beginPath(),o.arc(r.x,r.y,m*f*.3,0,Math.PI*2),o.fill()}),b.prevPositions=i}function v(e,t){o.fillStyle=g,o.strokeStyle=g,o.lineWidth=m*f,v.prevX!==null&&v.prevY!==null&&(o.beginPath(),o.moveTo(v.prevX,v.prevY),o.lineTo(e,t),o.stroke()),v.prevX=e,v.prevY=t}function y(e,t){if(o.fillStyle=g,o.strokeStyle=g,o.lineWidth=m*f,y.prevX!==null&&y.prevY!==null&&(o.beginPath(),o.moveTo(y.prevX,y.prevY),o.lineTo(e,t),o.stroke()),o.beginPath(),o.arc(e,t,m*f*.5,0,Math.PI*2),o.fill(),Math.random()<.1*f){const n=Math.floor(Math.random()*3)+1;for(let s=0;s<n;s++){const i=e+(Math.random()-.5)*m,r=m*(Math.random()*2+1)*f;o.beginPath(),o.moveTo(i,t),o.lineTo(i,t+r),o.stroke()}}y.prevX=e,y.prevY=t}h.prevX=null;h.prevY=null;p.prevX=null;p.prevY=null;b.prevPositions=[];v.prevX=null;v.prevY=null;y.prevX=null;y.prevY=null;function j(){E||(E=new(window.AudioContext||window.webkitAudioContext))}function Y(e,t=1.5){if(!E)return;const n=E.currentTime,s=E.createOscillator(),i=E.createGain();s.connect(i),i.connect(E.destination),s.type="sine",s.frequency.value=e,i.gain.setValueAtTime(0,n),i.gain.linearRampToValueAtTime(.3,n+.1),i.gain.exponentialRampToValueAtTime(.01,n+t),s.start(n),s.stop(n+t)}function Q(e,t){const n=["circle","triangle","square","pentagon","hexagon","star"],s=n[Math.floor(Math.random()*n.length)];return{x:e,y:t,type:s,size:20+Math.random()*30,color:`hsl(${Math.floor(Math.random()*360)}, 70%, 60%)`,life:1,decay:.01+Math.random()*.01,rotation:Math.random()*Math.PI*2}}function O(e,t){const n=Q(e,t);T.push(n);const i={circle:261.63,triangle:329.63,square:392,pentagon:440,hexagon:523.25,star:659.25}[n.type]||440;Y(i,1.5),q++,q%3===0&&(Y(i*1.25,1.5),Y(i*1.5,1.5))}function _(){for(let t=T.length-1;t>=0;t--){const n=T[t];n.x+=L.x*.05,n.y+=L.y*.05,n.x<-n.size&&(n.x=a.width+n.size),n.x>a.width+n.size&&(n.x=-n.size),n.y<-n.size&&(n.y=a.height+n.size),n.y>a.height+n.size&&(n.y=-n.size),n.life-=n.decay,n.life<=0&&T.splice(t,1)}}function ee(){T.forEach(e=>{switch(o.save(),o.globalAlpha=e.life,o.translate(e.x,e.y),o.rotate(e.rotation),o.strokeStyle=e.color,o.lineWidth=2,o.fillStyle=e.color.replace(")",", 0.2)").replace("hsl","hsla"),e.type){case"circle":o.beginPath(),o.arc(0,0,e.size,0,Math.PI*2),o.stroke(),o.beginPath(),o.arc(0,0,e.size*.5,0,Math.PI*2),o.stroke();break;case"triangle":o.beginPath();for(let t=0;t<3;t++){const n=t*Math.PI*2/3,s=Math.cos(n)*e.size,i=Math.sin(n)*e.size;t===0?o.moveTo(s,i):o.lineTo(s,i)}o.closePath(),o.stroke();break;case"square":o.beginPath(),o.rect(-e.size,-e.size,e.size*2,e.size*2),o.stroke(),o.beginPath(),o.moveTo(-e.size*.7,-e.size*.7),o.lineTo(e.size*.7,e.size*.7),o.moveTo(e.size*.7,-e.size*.7),o.lineTo(-e.size*.7,e.size*.7),o.stroke();break;case"pentagon":o.beginPath();for(let t=0;t<5;t++){const n=t*Math.PI*2/5-Math.PI/2,s=Math.cos(n)*e.size,i=Math.sin(n)*e.size;t===0?o.moveTo(s,i):o.lineTo(s,i)}o.closePath(),o.stroke();break;case"hexagon":o.beginPath();for(let t=0;t<6;t++){const n=t*Math.PI*2/6,s=Math.cos(n)*e.size,i=Math.sin(n)*e.size;t===0?o.moveTo(s,i):o.lineTo(s,i)}o.closePath(),o.stroke();break;case"star":o.beginPath();for(let t=0;t<10;t++){const n=t*Math.PI*2/10-Math.PI/2,s=t%2===0?e.size:e.size*.5,i=Math.cos(n)*s,r=Math.sin(n)*s;t===0?o.moveTo(i,r):o.lineTo(i,r)}o.closePath(),o.stroke();break}o.restore()}),o.globalAlpha=1}function G(){const e=document.getElementById("selectedTool");e&&(e.innerHTML=P[x].icon)}function I(e){if(e>0?x=(x+1)%P.length:x=(x-1+P.length)%P.length,w=P[x].name,G(),w==="llm")te();else switch(w){case"symmetry":X=4;break;case"kaleidoscope":break;case"brush":break;case"lines":break;case"drip":break;case"sacred":j();break}console.log(`Selected tool: ${P[x].label}`)}function te(){const e=document.getElementById("selectedTool");if(e){const t=document.createElement("div");if(t.style.cssText=`
      position: absolute;
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);
  ...
  `,l.addEventListener("click",()=>{const d=i.value.trim();if(d&&pe(d))t.remove(),me(e,d);else{const u=document.createElement("div");u.textContent="Please enter a valid email",u.style.cssText=`
        ...
        margin-top: 5px;
        text-align: center;
      `,n.appendChild(u),setTimeout(()=>{u.parentNode&&u.remove()},2e3)}}),c.addEventListener("click",()=>{t.remove()}),r.appendChild(l),r.appendChild(c),n.appendChild(s),n.appendChild(i),n.appendChild(r),t.appendChild(n),document.body.appendChild(t),i.focus()}function pe(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}async function me(e,t){try{const n=document.createElement("div");n.textContent="Processing artwork...",n.style.cssText=`
      position: fixed;
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);
      ...
      z-index: 100;
      pointer-events: none;
    `,document.body.appendChild(n);const s=e.split(",")[1];if(n.textContent="Sending artwork to LLM for email...",typeof PluginMessageHandler<"u"){const i={message:`Create and send an email with the following details:
        TO: ${t}
        ...
        ATTACHMENT: The image is provided in the imageBase64 field. Please attach it as a PNG file named "artwork.png".`,imageBase64:s,recipientEmail:t,useLLM:!0,wantsR1Response:!0};console.log("Sending image data to LLM for email");try{PluginMessageHandler.postMessage(JSON.stringify(i)),setTimeout(()=>{n.parentNode&&(n.textContent="Request sent to LLM for email processing...",setTimeout(()=>{n.parentNode&&n.remove()},3e3))},1e3)}catch(r){throw console.error("Error posting message to PluginMessageHandler:",r),new Error("Failed to communicate with LLM")}}else throw new Error("PluginMessageHandler not available - not running in R1 environment")}catch(n){console.error("Error processing image:",n);let s="Failed to process artwork: ";n.message.includes("PluginMessageHandler")?s+="Not running in R1 environment":s+=n.message;const i=document.createElement("div");i.textContent=s,i.style.cssText=`
      position: fixed;
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);

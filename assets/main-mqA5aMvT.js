(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function o(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=o(s);fetch(s.href,r)}})();console.log(typeof PluginMessageHandler<"u"?"Running as R1 Creation - Digital Painting App":"Running in browser mode - Digital Painting App");let a,n,I=!1,P="brush",f="#FE5F00",S="#F2F2F2",u=5,y=0,T=[],L={x:0,y:0,z:0},p=1,E=[],B=4,q=0,M=null,F=0;const w=[{name:"brush",icon:'<i class="fas fa-paint-brush"></i>',label:"Brush"},{name:"kaleidoscope",icon:'<i class="fas fa-magic"></i>',label:"Kaleidoscope"},{name:"symmetry",icon:'<i class="fas fa-sync-alt"></i>',label:"Symmetry"},{name:"drip",icon:'<i class="fas fa-fill-drip"></i>',label:"Drip Paint"},{name:"lines",icon:'<i class="fas fa-slash"></i>',label:"Lines"},{name:"llm",icon:'<i class="fas fa-microphone"></i>',label:"AI Advice"},{name:"sacred",icon:'<i class="fas fa-spa"></i>',label:"Sacred Geometry"}];function K(){a=document.getElementById("paintCanvas"),n=a.getContext("2d"),a.width=window.innerWidth,a.height=window.innerHeight,n.lineCap="round",n.lineJoin="round",n.fillStyle=S,n.fillRect(0,0,a.width,a.height),X()}function X(){E.push(n.getImageData(0,0,a.width,a.height)),E.length>20&&E.shift()}function Z(){if(E.length>1){E.pop();const e=E[E.length-1];n.putImageData(e,0,0),$()}}function $(){const e=document.createElement("div");e.textContent="Undo",e.style.cssText=`
  ...
  `,document.body.appendChild(e),setTimeout(()=>{e.remove()},2e3)}function oe(){const e=document.getElementById("canvasColorPicker"),t=document.getElementById("brushColorPicker");t.style.display==="flex"&&(t.style.display="none"),e.style.display==="flex"?e.style.display="none":(e.style.display="flex",e.querySelectorAll(".color-swatch").forEach(i=>{i.dataset.color===S?i.classList.add("selected-color"):i.classList.remove("selected-color")}))}function ie(){const e=document.getElementById("canvasColorPicker"),t=document.getElementById("brushColorPicker");e.style.display==="flex"&&(e.style.display="none"),t.style.display==="flex"?t.style.display="none":(t.style.display="flex",t.querySelectorAll(".color-swatch").forEach(i=>{i.dataset.color===f?i.classList.add("selected-color"):i.classList.remove("selected-color")}))}function se(e){S=e,n.fillStyle=S,n.fillRect(0,0,a.width,a.height),X(),document.getElementById("canvasColorPicker").style.display="none",console.log("Canvas background color set to:",e)}function ae(e){f=e,document.getElementById("brushColorPicker").style.display="none",console.log("Brush color set to:",e)}function re(e){I=!0;const t=a.getBoundingClientRect(),o=e.clientX-t.left,i=e.clientY-t.top;if(P==="sacred"){O(o,i);return}W(o,i)}function le(e){if(!I)return;const t=a.getBoundingClientRect(),o=e.clientX-t.left,i=e.clientY-t.top;if(P==="sacred"){Math.random()<.3&&O(o,i);return}W(o,i)}function N(){I&&(I=!1,X(),h.prevX=null,h.prevY=null,d.prevX=null,d.prevY=null,g.prevX=null,g.prevY=null,m.prevX=null,m.prevY=null)}function W(e,t){switch(P){case"brush":h(e,t);break;case"kaleidoscope":d(e,t);break;case"symmetry":b(e,t);break;case"lines":g(e,t);break;case"drip":m(e,t);break}}function ce(){window.DeviceMotionEvent&&window.addEventListener("devicemotion",s=>{s.accelerationIncludingGravity&&(L.x=s.accelerationIncludingGravity.x||0,L.y=s.accelerationIncludingGravity.y||0,L.z=s.accelerationIncludingGravity.z||0)});let e=0,t=0,o=0,i=15;window.addEventListener("devicemotion",s=>{if(s.accelerationIncludingGravity){const r=s.accelerationIncludingGravity.x||0,l=s.accelerationIncludingGravity.y||0,c=s.accelerationIncludingGravity.z||0,v=Math.abs(r-e),k=Math.abs(l-t),x=Math.abs(c-o);if(e=r,t=l,o=c,P!=="sacred"&&(v>i||k>i||x>i)){const C=Date.now();C-q>1e3&&(q=C,j())}}})}window.addEventListener("scrollUp",()=>{z(-1)});window.addEventListener("scrollDown",()=>{z(1)});window.addEventListener("sideClick",e=>(e&&(e.stopImmediatePropagation(),e.preventDefault()),U(),!1));document.addEventListener("keydown",e=>{if(e.key==="ArrowUp"&&(z(-1),e.preventDefault()),e.key==="ArrowDown"&&(z(1),e.preventDefault()),e.key==="Enter"){if(w[y].name==="llm"){G();return}U(),e.preventDefault()}});window.onPluginMessage=function(e){return console.log("Received plugin message:",e),event&&(event.stopImmediatePropagation(),event.preventDefault()),!1};typeof window<"u"&&(window.addEventListener("pluginMessage",function(e){return console.log("Received pluginMessage event:",e.detail),e.stopImmediatePropagation(),e.preventDefault(),!1},!0),window.addEventListener("beforeunload",function(e){return e.preventDefault(),e.returnValue="",""}),window.addEventListener("pagehide",function(e){return e.preventDefault(),!1}));function de(){K(),ce(),a.addEventListener("mousedown",re),a.addEventListener("mousemove",le),a.addEventListener("mouseup",N),a.addEventListener("mouseleave",N),a.addEventListener("touchstart",t=>{t.preventDefault();const o=t.touches[0],i=new MouseEvent("mousedown",{clientX:o.clientX,clientY:o.clientY});a.dispatchEvent(i)}),a.addEventListener("touchmove",t=>{t.preventDefault();const o=t.touches[0],i=new MouseEvent("mousemove",{clientX:o.clientX,clientY:o.clientY});a.dispatchEvent(i)}),a.addEventListener("touchend",t=>{t.preventDefault();const o=new MouseEvent("mouseup",{});a.dispatchEvent(o)}),document.getElementById("undoBtn").addEventListener("click",Z),document.getElementById("canvasColorBtn").addEventListener("click",oe),document.getElementById("eyedropperBtn").addEventListener("click",ie),document.querySelectorAll("#canvasColorPicker .color-swatch").forEach(t=>{t.addEventListener("click",()=>{document.getElementById("canvasColorPicker").querySelectorAll(".color-swatch").forEach(s=>s.classList.remove("selected-color")),t.classList.add("selected-color"),setTimeout(()=>{se(t.dataset.color)},200)})}),document.querySelectorAll("#brushColorPicker .color-swatch").forEach(t=>{t.addEventListener("click",()=>{document.getElementById("brushColorPicker").querySelectorAll(".color-swatch").forEach(s=>s.classList.remove("selected-color")),t.classList.add("selected-color"),setTimeout(()=>{ae(t.dataset.color)},200)})}),H();function e(){ee(),te(),requestAnimationFrame(e)}e(),console.log("R1 Digital Painting App initialized with tool:",P)}document.addEventListener("DOMContentLoaded",de);window.handleLLMResponse=function(e){const t=document.getElementById("adviceText"),o=document.getElementById("adviceOverlay");t&&o&&(t.textContent=e,o.style.display="flex",setTimeout(()=>{o.style.display="none"},5e3))};document.addEventListener("click",e=>{const t=document.getElementById("adviceOverlay");t&&e.target===t&&(t.style.display="none")});function U(){try{const e=a.toDataURL("image/png");ue(e)}catch(e){console.error("Error taking screenshot:",e);const t=document.createElement("div");t.textContent="Failed to capture artwork: "+e.message,t.style.cssText=`
    ...
    `,document.body.appendChild(t),setTimeout(()=>{t.parentNode&&t.remove()},5e3)}}async function ue(e){try{console.log("sendImageToR1System called with imageData length:",e.length);const t=document.createElement("div");if(t.textContent="Processing artwork...",t.style.cssText=`
      ...
      z-index: 100;
      pointer-events: none;
    `,document.body.appendChild(t),typeof PluginMessageHandler<"u"){const o={message:"Please send an email to the user with subject 'Test Email from R1 Digital Painting App' and body 'This is a test email to verify that the LLM can send emails.'",useLLM:!0,wantsR1Response:!1};console.log("Sending test message to LLM"),console.log("Test Payload:",JSON.stringify(o,null,2));try{PluginMessageHandler.postMessage(JSON.stringify(o)),console.log("Test message posted to PluginMessageHandler successfully"),setTimeout(()=>{t.parentNode&&(t.textContent="Test email request sent to LLM...",setTimeout(()=>{t.parentNode&&t.remove()},3e3))},1e3)}catch(i){throw console.error("Error posting message to PluginMessageHandler:",i),new Error("Failed to communicate with LLM")}}else throw console.error("PluginMessageHandler not available - not running in R1 environment"),new Error("PluginMessageHandler not available - not running in R1 environment")}catch(t){console.error("Error processing image:",t);let o="Failed to process artwork: ";t.message.includes("PluginMessageHandler")?o+="Not running in R1 environment":o+=t.message;const i=document.createElement("div");i.textContent=o,i.style.cssText=`
      position: fixed;
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);

...
async function sendImageToR1System(imageData) {
  try {
    ...
    if (typeof PluginMessageHandler !== 'undefined') {
      // Let's start with a very simple test message like in the SDK examples
      const testPayload = {
        message: "Please send an email to the user with subject 'Your Digital Artwork' and body 'Here is your artwork.'",
        useLLM: true,
        wantsR1Response: false
      };
      
      console.log('Sending simple test message to LLM');
